...
if (isset($_POST['search'])) {
    ...
    if ($valueToSearch == "") {
        ...
        $query = "select * from customer limit $halaman_awal, $batas";
    } else {
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div id="dataTable_filter" class="dataTables_filter">
                                <label>
                                    <form action="datacustomer.php" method="POST">
                                        Search:
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                <thead>
                                    <tr role="row">
                                        <th class="sorting sorting_desc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="internet: activate to sort column ascending" style="width: 161px;" aria-sort="descending">no. internet</th>

                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="nama: activate to sort column ascending">Nama</th>
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($data_pegawai)) : ?>
                                        <tr class="even">
                                            ...
                                            <td class="sorting_1"><?php echo $row['contact person']; ?></td>
                                            <td>
